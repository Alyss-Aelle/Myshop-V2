                        ...
                        <div class="header-column w-100">
                            <div class="header-row justify-content-between">
                                ...
                                <div class="d-flex col-auto col-lg-2 pe-0 ps-0 ps-xl-3">
                                    <ul class="header-extra-info">
                                        <li class="ms-0 ms-xl-4">
                                            <div class="header-extra-info-icon">
                                                <a href="{{route('dashboard')}}" class="text-decoration-none text-color-dark text-color-hover-primary text-2">
                                    ...
                                    <!--affichage des  produits dans la bulles panier-->
                                   <x-product.detailcart :carts='$carts'/>
