        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="summary entry-summary position-relative">
                    ...
                    <form enctype="multipart/form-data" method="get" class="cart" action="{{route('cart.add',$product)}}">
                     
                        <hr>
                        <div class="quantity quantity-lg">
                            <input type="button" class="minus text-color-hover-light bg-color-hover-primary border-color-hover-primary" value="-">
                            <input type="text" class="input-text qty text" title="Qty" value="1" id="{{$product}}"  name="quantity" min="1" step="1">
                            <input type="button" class="plus text-color-hover-light bg-color-hover-primary border-color-hover-primary" data-id="{{$product}}" value="+">
                        </div>
                        <button type="submit" class="btn btn-dark btn-modern text-uppercase bg-color-hover-primary border-color-hover-primary">Add cart</button>
                        <hr>
                    </form>
                ...
                <div class="products row">
                    <div class="col">
                        <div class="owl-carousel owl-theme nav-style-1 nav-outside nav-outside nav-dark mb-0" data-plugin-options="{'loop': false, 'autoplay': false, 'items': 4, 'nav': true, 'dots': false, 'margin': 20, 'autoplayHoverPause': true, 'autoHeight': true, 'stagePadding': '75', 'navVerticalOffset': '50px'}">
                            @foreach ($products as $productSimilar)
...
<span class="badge badge-ecommerce badge-success">NEW</span>
                                ...
                                <p class="price text-5 mb-3">
                                    <span class="sale text-color-dark font-weight-semi-bold">{{$productSimilar->price}}€</span>
