        ...
        <div class="col">
            <ul class="breadcrumb breadcrumb-dividers-no-opacity font-weight-bold text-6 justify-content-center my-5">
                <li class="text-transform-none me-2">
                    <a href="{{route('cart')}}" class="text-decoration-none text-color-dark text-color-hover-primary">Shopping Cart</a>
                </li>
                ...
                <li class="text-transform-none text-color-grey-lighten">
                    <a href="{{route('order.complete')}}" class="text-decoration-none text-color-grey-lighten text-color-hover-primary">Order Complete</a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="shop_table cart-totals mb-3">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong class="d-block text-color-dark line-height-1 font-weight-semibold">{{$itemCart->product->name}} <span class="product-qty">x{{$itemCart->quantity}}</span></strong>
                        ...
                        <a href="{{route('order.complete')}}" class="btn btn-dark btn-modern w-100 text-uppercase bg-color-hover-primary border-color-hover-primary border-radius-0 text-3 py-3">Place Order <i class="fas fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
