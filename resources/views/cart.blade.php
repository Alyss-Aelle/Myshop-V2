                        ...
                        <tr class="cart_table_item">
                            <td class="product-thumbnail">
                                <div class="product-thumbnail-wrapper">
                                    <a href="{{route('cart.destroy',$itemCart->id)}}" class="product-thumbnail-remove" title="Remove Product">
                            ...
                            <td class="product-name">
                                <a href="shop-product-sidebar-right.html" class="font-weight-semi-bold text-color-dark text-color-hover-primary text-decoration-none">{{$itemCart->product->name}}</a>
                            </td>
                            <td class="product-price">
                                <span class="amount font-weight-medium text-color-grey">{{$itemCart->price}}€</span>
                            </td>
                            <td class="product-quantity">
                                <div class="quantity float-none m-0">
                                    <input type="button" class="minus text-color-hover-light bg-color-hover-primary border-color-hover-primary" value="-">
                                    <input type="text" class="input-text qty text" title="Qty" id="{{$itemCart->product_id}}" value="{{$itemCart->quantity}}" name="quantity" min="1" step="1">
                                    <input type="button" class="plus text-color-hover-light bg-color-hover-primary border-color-hover-primary" data-id="{{$itemCart->product_id}}" value="+">
                                </div>
                            </td>
                            <td class="product-subtotal text-end">
                                <span class="amount text-color-dark font-weight-bold text-4"></span>
                            </td>
                        </tr>
                        @endforeach
                        <!--boucle cart-->
                            ...
                            <td colspan="5">
                                <div class="row justify-content-between mx-0">
                                    ...
                                    <div class="col-md-auto px-0">
                                        ...
                                        <a  href="{{route('cart.edit',$itemCart->id)}}" class="btn btn-light btn-modern text-color-dark bg-color-light-scale-2 text-color-hover-light bg-color-hover-primary text-uppercase text-3 font-weight-bold border-0 border-radius-0 btn-px-4 py-3">Update Cart</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        <tr class="cart-subtotal">
                            ...
                            <td class="border-top-0 text-end">
                                <strong><span class="amount font-weight-medium">{{$sommeTotal}}€</span></strong>
                            </td>
                        </tr>
                        <tr class="shipping">
                            <td colspan="2">
                        ...
                        <tr class="total">
                            ...
                            <td class="text-end">
                                <strong class="text-color-dark"><span class="amount text-color-dark text-5">{{$sommeTotal}}€</span></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
