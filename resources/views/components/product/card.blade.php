...
<span class="badge badge-ecommerce badge-success">NEW</span>
            ...
            <div class="addtocart-btn-wrapper">
                <a href="{{route('cart.add',$itemProduct)}}" class="text-decoration-none addtocart-btn" title="Add to Cart">
        ...
        <div class="d-flex justify-content-between">
            <div>
                ...
                <h3 class="text-3-5 font-weight-medium font-alternative text-transform-none line-height-3 mb-0"><a href="shop-product-sidebar-right.html" class="text-color-dark text-color-hover-primary"><li>{{{$itemProduct->name}}}</li></a></h3>
            </div>
